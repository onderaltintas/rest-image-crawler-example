...
Have no linux right now,also checked virtual machines, I must have deleted em. So couldn't create good crone job. I know how to use cron very well since
digital signage project. It should be something like:
...
- Could use prototypes but everyclass will have one instance anyways.
